      ...
      <div className="max-w-7xl mx-auto px-gutter py-section-gap grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="flex flex-col justify-between py-8">
          <div className="grid grid-cols-2 gap-8 mb-16">
            ...
            <div>
              ...
              <div className="flex gap-4 text-surface-variant dark:text-on-surface-variant">
                ...
                <a
                  aria-label="Email hello@ngarsa.com"
                  className="hover:text-primary-fixed transition-colors flex items-center justify-center"
          ...
          <div>
            ...
            <p className="font-body-md text-surface-variant dark:text-on-surface-variant mb-2 max-w-sm">{t("address")}</p>
            <p className="font-body-md text-surface-variant dark:text-on-surface-variant mb-8">
              <a
                href="mailto:hello@ngarsa.com"
                className="inline-flex items-center gap-2 hover:text-primary-fixed transition-colors font-semibold"
              >
